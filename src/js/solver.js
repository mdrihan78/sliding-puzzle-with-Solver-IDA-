...
window.solverLogic = (() => {
  // Web Worker stringified function
  function solverWorkerFunction(){
    self.onmessage = function(ev){
      try{
        ...
        // 4x4: Place first 6 tiles in order, then solve rest
        if(size === 4){
        ...
        // 5x5: Place first 12 tiles in order, then solve rest
        if(size===5){
